...
CREATE TABLE APPLICATION_USER (
    ...
    APPLICATION_USER_PASSWORD 		    TEXT		 	NOT NULL             	 ,
    APPLICATION_USER_PREFERRED_NAME 	VARCHAR(20) 	NOT NULL             	 ,
    APPLICATION_USER_POINTS 		    INTEGER	 	    NOT NULL 		DEFAULT 0,
	APPLICATION_USER_IMAGE 				VARCHAR(100)	DEFAULT 'https://res.cloudinary.com/sprout03/image/upload/v1621536156/default_profile_kf2nls.png',
...
CREATE TABLE USER_SPROUTS (
    ...
    USER_SPROUTS_LAST_WATERED           DATE            DEFAULT NULL                 ,  
    USER_SPROUTS_NEXT_ALERT_DATE 	    DATE 		    NOT NULL 		DEFAULT NOW(),
	USER_SPROUTS_IMAGE					VARCHAR(100)	DEFAULT 'https://res.cloudinary.com/sprout03/image/upload/v1621536166/default_sprout_qlbudo.png',
	UNIQUE(APPLICATION_USER_ID, USER_SPROUTS_GIVEN_NAME),
	CONSTRAINT check_watering_intervals CHECK(user_sprouts_watering_intervals > 0),
...
CREATE TABLE ALERTS (
	...
	ALERTS_MESSAGE 			VARCHAR(100) 	NOT NULL,
	FOREIGN KEY(USER_SPROUTS_ID) REFERENCES USER_SPROUTS ON UPDATE CASCADE
);
